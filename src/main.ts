...
export function main (){initializeReverseProxy(new function(){
  this.domain = "test.jesterromut.uk";
  ...
  const wikiPage = ''
  this.slugToPage = {
      "": "55b1800f943d4462a5a068276298bee6",
      "wiki": "11720e7ce8938011bf0fda2644779e1f",
      "artworks": artPage,
      "characters": chrPage,
      "worldviews": wldPage,
    };

  const jester = "Jester Romut";
  // Metatags, optional
  ...
  this.pageMetadata = {
    ...
    [chrPage]: {
      title: '华丽终幕 | 嘉登糖尿病的角色',
      description: '震惊！是拥有怎样的精神状态，才能让一未成年小孩姐在家设计出如此这般这般的角色？！那个钨尔维克为何天天炸膛，那个总爱视奸人的麦克白究竟又有何来头？关注嘉登糖尿病，让我们跟随镜头走进无敌发条战士的内心世界……',
      image: this.siteImage,
      author: jester,
    },
    [wldPage]: {
